...
const VERSION_LOG = [
  { v: 'V2.54', date: '2026.08', notes: ['Google Analytics(GA4) 방문자 추적 태그 추가 (측정ID: G-HXESL6GJ26)'] },
  { v: 'V2.53', date: '2026.08', notes: ['모바일을 쇼핑몰 앱 스타일로 전면 개편 — 카드 대폭 컴팩트화, 모든 팝업을 하단에서 올라오는 바텀시트로 전환, 필터 칩 가로스와이프 지원. PC 화면은 전혀 변경 없음(980px 이하에서만 적용)'] },
...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '<b>JMW(한국) / 소싱</b> 칩으로 자체 개발과 소싱(해외 외주) 제품 구분 — 모든 카테고리에 항상 두 칩 다 표시',
  ...
  {
    icon: '💬', title: '우측 하단 바로가기',
    items: [
      '화면 <b>우측 하단 보라색 버튼</b>을 누르면 JMW·바이툴즈 카카오톡·유튜브 채널로 바로 이동',
      '각 항목 옆 작은 아이콘으로 <b>링크 복사</b>도 가능',
      '스크롤을 내리면 그 위에 <b>"맨 위로" 버튼</b>이 자동으로 나타납니다',
    ]
  },
];
